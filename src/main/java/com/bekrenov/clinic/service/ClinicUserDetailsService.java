...
@Service
public class ClinicUserDetailsService implements UserDetailsManager {
    ...
    public ClinicUserDetailsService(JdbcUserDetailsManager jdbcUserDetailsManager, AuthenticationManager authenticationManager, PasswordEncoder passwordEncoder) {
